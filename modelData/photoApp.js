...
(function () {
   ...
   comment8, comment9, comment10, comment11, comment12, comment13];
    ...
    var event1 = {
        ...
        file_name: "kenobi2.jpg", // 	Name of a file containing a photo (for photo upload / photo comment events)
        date_time: "2016-01-04 2:04:01",
        user: pt // The user object of the user who created the event
    };

    var event2 = {
        event_type: String, // Type of event (photo upload, comment, user registration, user login, user logout)
        description: "Test Event #2",
        file_name: "kenobi1.jpg", // 	Name of a file containing a photo (for photo upload / photo comment events)
        date_time: "2016-01-04 2:04:01",
        user: pt // The user object of the user who created the event
    };
    ...
    var event3 = {
        ...
        file_name: "malcolm1.jpg", // 	Name of a file containing a photo (for photo upload / photo comment events)
        date_time: "2016-01-04 2:04:01",
        user: pt // The user object of the user who created the event
    };
